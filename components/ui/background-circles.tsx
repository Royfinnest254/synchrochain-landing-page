...
const AnimatedGrid = () => {
    // Casting motion to any to bypass environment-specific property definition errors
    ...
    return (
        ...
        >
            ...
            >
                <h1
                    className={clsx(
                        ...
                        "drop-shadow-[0_0_32px_rgba(30,58,138,0.4)]"
                    )}
                >
                    {title}
                </h1>
            ...
            <div className="absolute inset-0 [mask-image:radial-gradient(90%_60%_at_50%_50%,#000_40%,transparent)] pointer-events-none">
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,#1E3A8A/30%,transparent_70%)] blur-[120px]" />
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,#3B82F6/15%,transparent)] blur-[80px]" />
            </div>
        </div>
    );
}
